...
var map_ObjectMeta = map[string]string{
	...
	"tenant":                     "Tenant defines the tenant",
...
var map_TenantSpec = map[string]string{
	...
	"namespaces": "There must be at least one namespace in a tenant",
}
...
var map_TenantStatus = map[string]string{
	...
	"phase": "Phase is the current lifecycle phase of the tenant.",
}
