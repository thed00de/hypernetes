...
func NewProxier(loadBalancer LoadBalancer, listenIP net.IP, iptables iptables.Interface, pr util.PortRange, syncPeriod time.Duration, kubeClient *kubeclient.Client, withHaproxier bool) (*Proxier, error) {
	...
	return createProxier(loadBalancer, listenIP, iptables, hostIP, proxyPorts, syncPeriod, kubeClient, withHaproxier)
}
...
func createProxier(loadBalancer LoadBalancer, listenIP net.IP, iptables iptables.Interface, hostIP net.IP, proxyPorts PortAllocator, syncPeriod time.Duration, kubeClient *kubeclient.Client, withHaproxier bool) (*Proxier, error) {
