...
func (plugin *execNetworkPlugin) SetUpPod(namespace string, name string, id kubetypes.DockerID, containerRuntime string) error {
...
func (plugin *execNetworkPlugin) TearDownPod(namespace string, name string, id kubetypes.DockerID, containerRuntime string) error {
...
func (plugin *execNetworkPlugin) Status(namespace string, name string, id kubetypes.DockerID, containerRuntime string) (*network.PodNetworkStatus, error) {
